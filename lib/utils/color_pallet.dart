...
class Pallete {
  static const gradient1 = Color(0xFF356859);
  static const gradient2 = Color(0xFFFF5722);
  static const gradient3 = Color(0xFFFFFBE6);
  static const Color backgroundColor = Color.fromRGBO(24, 24, 32, 1);
  static const Color borderColor = Color.fromRGBO(52, 51, 67, 1);
  static const Color whiteColor = Colors.white;
  static const Color green = Color(0XFF7DDA58);
  static const Color orange = Color(0XFFFF8100);
  static const Color orangeAccent = Color(0XFFF2B5AA);
  ...
  static const colorCombi = {
    ...
    'Green & Black': {
      'background': Color.fromARGB(255, 0, 128, 0), // Green background
    ...
    'Brown & Beige': {
      'background': Color.fromARGB(255, 139, 69, 19), // Brown background
    ...
    'Teal & Coral': {
      ...
      'text': Color.fromARGB(255, 255, 127, 80), // Coral text
    },
    'Turquoise & Dark Red': {
      'background': Color.fromARGB(255, 64, 224, 208), // Turquoise background
    ...
    'Slate Gray & Snow': {
      ...
      'text': Color.fromARGB(255, 255, 250, 250), // Snow text
    }
  };
}
